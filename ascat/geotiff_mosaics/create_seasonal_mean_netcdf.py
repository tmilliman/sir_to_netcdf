...
if __name__ == "__main__":
    ...
    for year in range(common.START_YEAR, common.END_YEAR + 1):
        for season in season_list:
            ...
            fname = "ascat_msfa_mean_db_{}_{}.tif"
    ...
    ds.attrs["title"] = "ASCAT sigma-0 Seasonal Mean"
    ds.attrs["description"] = "ASCAT seasonal mean msfa sigma-0"
    ...
    outfile = "ASCAT_seasonal_land_sig0_mean.nc"
