...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create ERS1/2 urban masked seasonal sig0 mean netcdf"
    )
    ...
    for year in range(common.START_YEAR, common.END_YEAR + 1):
        for season in season_list:
            ...
            fname = "ers_ers12_mean_db_{}_{}_masked_{}.tif"
    ...
    ds.attrs["title"] = "ERS1/2 sigma-0 {} Masked Seasonal Mean"
    ds.attrs["description"] = (
        "ERS1/2 seasonal mean ers1/2 sigma-0 with " + "urban and water masks"
    )
    ...
    outfile = "ERS_seasonal_urban_sig0_mean.nc"
