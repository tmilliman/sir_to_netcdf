...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create ERS1/2 seasonal urban sig0 std netcdf"
    )
    ...
    ds.attrs["title"] = "ERS1/2 sigma-0 Seasonal Std. Dev."
    ds.attrs["description"] = "ERS1/2 std from {} mean ers1/2 sigma-0"
    ...
    outfile = "ERS_seasonal_land_sig0_StdDev.nc"
