...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create ERS1/2 seasonal urban masked sig0 std netcdf"
    )
    ...
    for year in range(common.START_YEAR, common.END_YEAR + 1):
        for season in season_list:
            ...
            fname = "ers_ers12_std_db_{}_{}_masked_{}.tif"
    ...
    ds.attrs["title"] = "ERS1/2 sigma-0 Masked Seasonal Std. Dev."
    ds.attrs["description"] = (
        "ERS1/2 std from {} mean ers1/2 sigma-0 with " + "urban and water masks"
    )
    ...
    outfile = "ERS_seasonal_urban_sig0_StdDev.nc"
