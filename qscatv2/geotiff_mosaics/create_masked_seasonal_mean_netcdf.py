...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create QuikSCAT urban masked seasonal sig0 mean netcdf"
    )
    ...
    for year in range(common.START_YEAR, common.END_YEAR + 1):
        for season in season_list:
            ...
            fname = "qscat_quev_mean_db_{}_{}_masked_{}.tif"
    ...
    ds.attrs["title"] = "QuikSCAT sigma-0 Masked Seasonal Mean"
    ds.attrs["description"] = (
        "QuikSCAT seasonal mean quev sigma-0 with " + "urban and water masks"
    )
    ...
    outfile = "QuikSCAT_seasonal_urban_sig0_mean.nc"
