...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create QuikSCAT seasonal sig0 std netcdf"
    )
    ...
    ds.attrs["title"] = "QuikSCAT sigma-0 Seasonal Std. Dev."
    ds.attrs["description"] = "QuikSCAT std from seasonal mean quev sigma-0"
    ...
    outfile = "QuikSCAT_seasonal_land_sig0_StdDev.nc"
