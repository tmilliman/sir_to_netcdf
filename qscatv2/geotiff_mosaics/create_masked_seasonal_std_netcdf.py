...
if __name__ == "__main__":
    ...
    ds.attrs["title"] = "QuikSCAT sigma-0 Masked Seasonal Std. Dev."
    ds.attrs["description"] = (
        "QuikSCAT std from seasonal mean quev sigma-0 with " + "urban and water masks"
    )
    ...
    outfile = "QuikSCAT_seasonal_urban_sig0_StdDev.nc"
