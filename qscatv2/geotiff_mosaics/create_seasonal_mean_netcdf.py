...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Create QuikSCAT seasonal sig0 mean netcdf"
    )
    ...
    for year in range(common.START_YEAR, common.END_YEAR + 1):
        for season in season_list:
            ...
            fname = "qscat_quev_mean_db_{}_{}.tif"
    ...
    ds.attrs["title"] = "QuikSCAT sigma-0 Seasonal Mean"
    ds.attrs["description"] = "QuikSCAT seasonal mean quev sigma-0"
    ...
    outfile = "QuikSCAT_seasonal_land_sig0_mean.nc"
